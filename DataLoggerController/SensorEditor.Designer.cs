namespace DataLoggerController
{
	partial class SensorEditor
	{
		...
		private void InitializeComponent()
		{
			...
			// button3
			// 
			this.button3.Location = new System.Drawing.Point(327, 291);
			...
			this.Name = "SensorEditor";
			this.Text = "Sensor Editor";
			this.Load += new System.EventHandler(this.SensorEditor_Load);
